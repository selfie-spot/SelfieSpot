...
public class SelfieSpotsMapActivity extends FragmentActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private void loadMap(final GoogleMap googleMap) {
        mMap = googleMap;
        SelfieSpotsMapActivityPermissionsDispatcher.getMyLocationWithCheck(this);
    }

    @Override
    public void onRequestPermissionsResult(final int requestCode, final String[] permissions, final int[] grantResults) {
        super.onRequestPermissionsResult(requestCode, permissions, grantResults);
        SelfieSpotsMapActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
