...
@RuntimePermissions
public class SelfieSpotsMapFragment extends SupportMapFragment implements GoogleApiClient.ConnectionCallbacks,
    ...
    private void loadMap(final GoogleMap googleMap) {
        mMap = googleMap;
        SelfieSpotsMapFragmentPermissionsDispatcher.getMyLocationWithCheck(this);
    }

    @Override
    public void onRequestPermissionsResult(final int requestCode, final String[] permissions, final int[] grantResults) {
        super.onRequestPermissionsResult(requestCode, permissions, grantResults);
        SelfieSpotsMapFragmentPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
